...
/**
 * Sends global events to other contexts. These events usually contain data
 * that will be duplicated in their application to avoid runtime dependencies.
 * 
 * Domain events should never be sent to other services. They should be mapped to an service event
 * to avoid core domain event coupling to external apis.
 * 
